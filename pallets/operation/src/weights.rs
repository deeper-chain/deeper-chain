...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn set_release_limit_parameter() -> Weight {
        (1_000_000 as Weight).saturating_add(T::DbWeight::get().writes(2 as Weight))
    }
    fn staking_release() -> Weight {
...
impl WeightInfo for () {
    ...
    fn set_release_limit_parameter() -> Weight {
        (1_000_000 as Weight).saturating_add(RocksDbWeight::get().writes(2 as Weight))
    }
    fn staking_release() -> Weight {
        (30_000_000 as Weight)
