...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn add_credit_by_traffic() -> Weight {
        Weight::from_all(88_843_000 as u64)
            .saturating_add(T::DbWeight::get().reads(4 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
    fn set_atmos_pubkey() -> Weight {
        Weight::from_all(1_872_000 as u64).saturating_add(T::DbWeight::get().writes(1 as u64))
    }
}
...
impl WeightInfo for () {
    ...
    fn set_atmos_pubkey() -> Weight {
        Weight::from_all(1_872_000 as u64).saturating_add(RocksDbWeight::get().writes(1 as u64))
    }
}
