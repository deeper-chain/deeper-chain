...
contract deeper {
    address private constant DISPATCH = 0x000000000000000000000000000000000000000A;
    event score( uint256 indexed);
    event addrevent( address indexed  addr);
    event data( bytes);
...
function bytesToAddress(bytes memory bys) internal pure returns (address addr) {
 ...
 function get_credit_score(address query_address)  public returns (uint256) {
    ...
    (bool success, bytes memory x) = DISPATCH.call(abi.encodeWithSignature("get_credit_score(address)",query_address));
  ...
  function add_credit_score(address query_address,uint256 num)  public {
    ...
    (bool success, ) = DISPATCH.call(abi.encodeWithSignature('add_credit_score(address,uint256)',query_address,num));
        require(success, "operation ok");
   ...
   function slash_credit_score(address query_address,uint256 num)  public {
    ...
    (bool success, ) = DISPATCH.call(abi.encodeWithSignature('slash_credit_score(address,uint256)',query_address,num));
        require(success, "operation ok");
