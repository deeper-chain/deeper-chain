use crate::{mock::*, Error, CreditDelegateInterface};
use frame_support::{
...
fn test_delegate() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(Delegating::candidate_delegators(4), vec![(10, 65)]);
        ...
        assert_eq!(Delegating::candidate_delegators(6), vec![(11, 16)]);
        assert_eq!(Delegating::candidate_delegators(8), vec![(11, 16)]);
        assert_eq!(Delegating::candidate_delegators(10), vec![(11, 16)]);
        ...
        assert_eq!(
            ...
            Err(DispatchErrorWithPostInfo::from(Error::<Test>::NotInCandidateValidator))
        );
        ...
        assert_eq!(
            ...
            Err(DispatchErrorWithPostInfo::from(Error::<Test>::AlreadyDelegated))
        );
    });
}
...
fn test_undelegate() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(
            ...
            Err(DispatchErrorWithPostInfo::from(Error::<Test>::NotDelegate))
        );
    });
}
