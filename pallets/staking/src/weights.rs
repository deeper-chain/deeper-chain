...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn force_no_eras() -> Weight {
        (3_440_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_new_era() -> Weight {
        (3_460_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn force_new_era_always() -> Weight {
        (3_450_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn set_invulnerables(v: u32) -> Weight {
        (3_603_000 as Weight)
            // Standard Error: 0
...
impl WeightInfo for () {
    ...
    fn force_no_eras() -> Weight {
        (3_440_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn force_new_era() -> Weight {
        (3_460_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn force_new_era_always() -> Weight {
        (3_450_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn set_invulnerables(v: u32) -> Weight {
        (3_603_000 as Weight)
            // Standard Error: 0
