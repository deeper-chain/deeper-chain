...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn update_credit_setting() -> Weight {
        (10_609_000 as Weight).saturating_add(T::DbWeight::get().writes(2 as Weight))
    }
    fn add_or_update_credit_data() -> Weight {
        (21_111_000 as Weight)
...
impl WeightInfo for () {
    fn update_credit_setting() -> Weight {
        (10_609_000 as Weight).saturating_add(RocksDbWeight::get().writes(2 as Weight))
    }
    fn add_or_update_credit_data() -> Weight {
        (21_111_000 as Weight)
