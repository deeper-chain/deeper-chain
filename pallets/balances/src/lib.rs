...
pub trait MutableCurrency<AccountId>: Currency<AccountId> {
...
pub mod pallet {
    ...
    pub type Locks<T: Config<I>, I: 'static = ()> =
        StorageMap<_, Blake2_128Concat, T::AccountId, WeakBoundedVec<BalanceLock<T::Balance>, T::MaxLocks>, ValueQuery>;
