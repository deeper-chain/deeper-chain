../target/release/e2-chain build-spec --disable-default-bootnode --chain local > first.json
...
../target/release/e2-chain build-spec --chain=second.json --raw --disable-default-bootnode > customSpecRaw.json
