...
parameter_types! {
    ...
    pub const CooloffPeriod: BlockNumber = 8 * MINUTES;
    // One cent: $10,000 / MB
...
parameter_types! {
    pub const CouncilMotionDuration: BlockNumber = 18 * MINUTES;
...
parameter_types! {
    ...
    pub const BountyDepositPayoutDelay: BlockNumber = 12 * MINUTES;
    pub const TreasuryPalletId: PalletId = PalletId(*b"py/trsry");
    pub const BountyUpdatePeriod: BlockNumber = 15 * MINUTES;
